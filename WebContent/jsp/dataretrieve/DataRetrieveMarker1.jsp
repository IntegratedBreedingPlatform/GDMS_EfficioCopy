...
<%-- 													<%} %> --%>
									...
									<span style="visibility: hidden;" id="sec">
										<table>
											<tr>
											<td class="displayText">Select Marker Type:</td>												
												<td>&nbsp;&nbsp;
													<select name="List2" onchange="selectType(this.value)" style="COLOR: #666; FONT-SIZE: 11px">
														<option value="">- Select -</option>
									...
									<span style="visibility: hidden;" id="third">
										<table>
											<tr>
												<td class="displayText"><div id="text2"></div></td>
												<td>&nbsp;&nbsp;
													<select name="List3"  multiple="true" size="4" style="COLOR: #666; FONT-SIZE: 11px">
														<option value="">- Select -</option>
														
													</select>
												</td>
											
												<td class="displayText"><input type="checkbox" name="all" onclick="loop_select()"> Select all Markers</td>
											</tr>
										</table>																										
									</span>							
								</span>	
					...
					<br>
				<input type="button" name="backButton" value="Back" onclick="javascript:history.back()"/>
...
<script type="text/javascript">
			...
			function getDeta(type,val,name){
				...
				//alert("type="+type+"   val="+val+"   name="+name);
				url='retrieveData.do?data='+val+'!!'+type+'&type='+name;
			...
			function select(ab){
				...
				if(document.forms[0].elements['List1'].value!=""){
			...
			function selectType(ab){
				//alert(ab)
				if(document.forms[0].elements['List2'].value!="- Select -"){
					tp="List3";
					va=SelectedValue;
			...
			function validatePage(){
				...
				if(Selectedoption==""){
					...
					if(Selectedoption=="QuickSearch"){
						...
						//alert(Selectedoption+"   "+SelectedValue);
						var value=document.forms[0].elements['List1'].value;
						if(value==null||value==""||value=="- Select -"){
							alert("Select the "+SelectedValue+".");
							return false;
						}
						if(SelectedValue!="Marker_Type"){
							var Markervalue=document.forms[0].elements['List2'].value;
						
						}else{
							var Markervalue=document.forms[0].elements['List3'].value;
						}
						if((Markervalue==null||Markervalue==""||Markervalue=="- Select -")&&(SelectedValue!="genotype")){
